...
class InputX:
    def __init__(
        self, initVal, offset, gain, kp, toAu, offset_au, minMax_au, modulu_au=None
    ):
        self.val_Z1 = initVal
        self.offset = offset
        self.gain = gain
...
class Hand(InputX):
    def __init__(
        self, initVal, offset, gain, kp, toDeg, offset_deg, minMax_deg, modulu_deg, skin
    ):
        super().__init__(
            initVal, offset, gain, kp, toDeg, offset_deg, minMax_deg, modulu_deg
        )
        self.skin = skin
