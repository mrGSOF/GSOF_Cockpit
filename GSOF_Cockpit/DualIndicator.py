...
class DualIndicator(SingleIndicator):
    ...
    def __init__(self, screen, pos=(0,0), size=(0,0),
                bodyImage=None, handAImage=None, handBImage=None, iconImage=None,
                initVal     = 0.0,
                inputGain   = 1.0,
                inputOffset = 0.0,
                kp          = 0.8,
      ...
      super().__init__(screen=screen, bodyImage=bodyImage, handImage=handAImage, #iconImage=iconImage,
                       pos=pos, size=size,
                       initVal     = initVal,
                       inputGain   = inputGain,
    ...
    def draw(self, iconLayer = None):
        ...
        handA = Dial_base.rotate(self._handA.skin, int(self._handA.angle_deg)) #< Rotate the hand
        handB = Dial_base.rotate(self._handB.skin, int(self._handB.angle_deg)) #< Rotate the hand
