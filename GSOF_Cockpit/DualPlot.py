...
class DualPlot(Plot_base):
   ...
   def __init__(self, screen, pos=(0,0), size=(75,120),
      ...
      h = self.height/4
      self.plots = [InputX(initVal=A_initVal, offset=A_Offset, gain=A_Gain, kp=1.0, toAu=A_phyToPlot/2, offset_au=A_plotZero, minMax_au=(-h, h), modulu_au=None),
                    InputX(initVal=B_initVal, offset=B_Offset, gain=B_Gain, kp=1.0, toAu=B_phyToPlot/2, offset_au=B_plotZero, minMax_au=(-h, h), modulu_au=None)
                   ]
