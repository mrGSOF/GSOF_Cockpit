...
from GSOF_Cockpit.GraphicsLib import blit, fillSurface, getSurface, initFont, getFont, renderText
...
class DotMatrixDisplay(Gauge):
    ...
    def printAt(self, col, row, s, X2=False):
        ...
        blit(self._dial, TextSurf, (self.ofsX +x*self.chrSizeX, self.ofsY +y*self.chrSizeY))
    ...
    def printBmpAt(self, bmp, x, y):
        ...
        blit(self._dial, bmp,(self.ofsX +x*self.scale, self.ofsY +y*self.chrSizeY))
