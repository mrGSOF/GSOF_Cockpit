...
class SetPointVsFeedbackFill(DualIndicator):
    ...
    def __init__(
        ...
        if bodyImage == None:
            bodyImage = imageLoad(
                os.path.join(path, "../resources/EngineIndicator_Background.png")
            )
        if setPointImage == None:
            setPointImage = imageLoad(
                os.path.join(path, "../resources/EngineIndicator_Needle.png")
            )
        if feedbackImage == None:
            feedbackImage = imageLoad(
                os.path.join(path, "../resources/AirSpeedNeedle.png")
            )
